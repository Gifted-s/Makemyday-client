...
export default class EventPage extends Component {
    state={
      ...
      await fetch(`https://mmdapi.herokuapp.com/devapi/v1/getUser/${id}`)
   ...
   async handlePayment(){
     ...
     const makePayment = await fetch('https://mmdapi.herokuapp.com/devapi/v1/makePayment', {
      method:'Post',
      headers:{
            ...
            <div className="container-fluid event">
              ...
              <p className="text-light">Page made by {this.state.data.name}</p> 
               ...
               <p className="date__">Event Date : {this.state.data.eventSchedule.eventDate}</p>
                ...
                <p style={{fontSize:15}}>Here are the materials needed for this event</p>
                ...
                <div style={{fontWeight:'bold'}} className="row">
                    {
                        this.state.data.eventSchedule.items.map((material)=>{
                            return(
                                <div  className="col-md-3 mt-3 col-sm-6 ev__">
                                  {
                                    material.qty >=1
                                     ?
                                     ...
                                     <div style={{display:'block', padding:20}} className="card-body">
                                      ...
                                      <p  className="card-text">Quantity needed {material.qty}</p>
                                      <hr/>
  ...
  <div style={{fontWeight:'bold'}} className="mt-3 row">
      {
       ...
       <div style={{display:'block', padding:20}} className="card-body">
        ...
        <hr/>
         ...
         :<React.Fragment>
             <h4>No item added yet, please add some items</h4>
         </React.Fragment>
      }
